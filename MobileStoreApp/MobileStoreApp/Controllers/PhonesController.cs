...
namespace MobileStoreApp.Controllers
{
    public class PhonesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PhoneId,Name,Description,MyProperty,Quantity")] Phone phone)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PhoneId,Name,Description,MyProperty,Quantity")] Phone phone)
        {
            if (id != phone.PhoneId)
            {
                return NotFound();
